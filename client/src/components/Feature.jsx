...
const Feature = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-center bg-gradient-to-r from-indigo-400 via-purple-400 to-cyan-400 text-transparent bg-clip-text">
        Key Features
      </h2>
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl">
        {features.map((feature, index) => (
          <div
            key={index}
            className="group bg-[#1E293B]/60 backdrop-blur-md p-8 rounded-2xl border border-indigo-900/30 hover:border-indigo-500/50 transition-all duration-500 shadow-[0_0_10px_rgba(99,102,241,0.15)] hover:shadow-[0_0_25px_rgba(99,102,241,0.4)] hover:-translate-y-2"
          >
